...
from books import turn_str_into_collection


class TestStrIntoCollection(TestCase):

    def test_turn_str_into_collection_a_str_collection_of_random_books(self):
        str_collection = "Author	Title	Publisher	Shelf	Category	Subject\n" \
        ...
        actual = turn_str_into_collection(str_collection)
...
Fiction', 'Subject': 'Fantasy'})
    ...
    def test_turn_str_into_collection_a_str_collection_of_same_books(self):
        str_collection = "Author	Title	Publisher	Shelf	Category	Subject\n" \
               "Dupre	Skyscrapers	BD&L	12	Architecture	20th Century\n" \
               "Dupre	Skyscrapers	BD&L	12	Architecture	20th Century"
        actual = turn_str_into_collection(str_collection)
...
Shelf': '12', 'Category': 'Architecture', 'Subject': '20th Century'})
    ...
    def test_turn_str_into_collection_a_str_collection_that_books_dont_have_publisher(self):
        str_collection = "Author	Title	Publisher	Shelf	Category	Subject\n" \
                   "Eddings	Belgarath the Sorcerer		34	Fiction	Fantasy\n" \
                   "Eddings	Castle of Wizardry		34	Fiction	Fantasy\n" \
                   "Eddings	Demon Lord of Karanda		34	Fiction	Fantasy\n" \
...
Fiction', 'Subject': 'Fantasy'})
    ...
    def test_turn_str_into_collection_a_str_collection_that_first_book_doesnt_have_publisher_second_book_has(self):
        str_collection = "Author	Title	Publisher	Shelf	Category	Subject\n" \
                   "Dupre	Skyscrapers	BD&L	12	Architecture	20th Century\n" \
                   "Eddings	Enchanter's End Game		34	Fiction	Fantasy"
        actual = turn_str_into_collection(str_collection)
